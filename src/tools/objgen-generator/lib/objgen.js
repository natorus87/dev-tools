...
const isArray = Array.isArray || ((v) => Object.prototype.toString.call(v) === "[object Array]");
const isEmpty = (v) => v === "" || (typeof v === "object" && v !== null && Object.keys(v).length === 0);

export const ObjGen = function() {};
      ...
      if(modelParent !== null) {
        if(modelParent.array) {
          ...
          if((curProp.genParent.length < modelParent.index + 1) ||
            (isArray(curProp.genParent[modelParent.index]) && isEmpty(curProp.genParent[modelParent.index]))) {
